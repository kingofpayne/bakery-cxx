...
/**
 * Initializes the dat_map_assignment rule.
 *
 * @param rules Reference over the rules container.
 */
template <typename I>
    void generic_init_dat_map_assignment(rule_container_t<I> & rules)
{
...
template <>
    void init_dat_map_assignment<iterator>(rule_container_t<iterator> & rules)
{
